...
func CreateUserOps() []*SignedUserOperation {
	...
	for i := 0; i < 62; i++ {
		...
		if i == 3 {
			userOpCounter.Nonce1 = hexutil.Uint64(1)
			userOpCounter.ChainId1 = hexutil.Uint64(hexTo("0xaa36a6").Uint64())
			userOpCounter.CallData1 = common.FromHex("")
			userOpCounter.MainChainGasLimit1 = 0x30d40
			userOpCounter.DestChainGasLimit1 = 0
			userOpCounter.ZkVerificationGasLimit1 = 0x898
			userOpCounter.MainChainGasPrice1 = hexTo("0x9502f900")
			userOpCounter.DestChainGasPrice1 = hexTo("0x0")
		}

		if i == 12 {
			userOpCounter.Nonce1 = hexutil.Uint64(2)
			userOpCounter.ChainId1 = hexutil.Uint64(hexTo("0xaa36a6").Uint64())
			userOpCounter.CallData1 = common.FromHex("")
			userOpCounter.MainChainGasLimit1 = 0x30d40
			userOpCounter.DestChainGasLimit1 = 0
		...
		if i == 52 {
			userOpCounter.Nonce1 = hexutil.Uint64(3)
			userOpCounter.ChainId1 = hexutil.Uint64(hexTo("0xaa36a6").Uint64())
			userOpCounter.CallData1 = common.FromHex("")
			userOpCounter.MainChainGasLimit1 = 0x30d40
			userOpCounter.DestChainGasLimit1 = 0
		...
		if i == 61 {
			userOpCounter.Nonce1 = hexutil.Uint64(4)
			userOpCounter.ChainId1 = hexutil.Uint64(hexTo("0xaa36a6").Uint64())
			userOpCounter.CallData1 = common.FromHex("")
			userOpCounter.MainChainGasLimit1 = 0x30d40
			userOpCounter.DestChainGasLimit1 = 0
